                        ...
                        <section className="mb-12">
                            ...
                            {flashcardDecks.length === 0 ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="mt-2 text-lg font-medium text-gray-900">No flashcard decks yet</h3>
                                    <p className="mt-1 text-gray-500">Get started by creating your first flashcard deck.</p>
                                    <div className="mt-6">
