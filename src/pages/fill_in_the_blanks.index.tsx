...
const FillInBlanks = () => {
    ...
    useEffect(() => {
        getFillInBlankDecks(supabase).then((data) => {
            setFillInBlankDecks(data);
        })
    }, [supabase])

    const handleCreateFillInBlanks = () => {
        navigate('/fill-in-the-blanks/make');
    };
    ...
    return (
        <>
                ...
                <section className="mb-12">
                    ...
                    {fillInBlankDecks.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <h3 className="mt-2 text-lg font-medium text-gray-900">No fill in blank decks</h3>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {fillInBlankDecks.map((deck) => (
                                <div
                                    key={deck.id}
                                ...
                                >
                                    <div className="p-5 h-full flex flex-col">
                                        ...
                                        <div className="mt-auto pt-4 flex justify-between items-center">
                                            <Link to={`/fill-in-the-blanks/${deck.id}/session/${uuidv4()}`}>
            ...
            <FloatingActionButton 
                onClick={handleCreateFillInBlanks}
                label="Create new fill in the blanks"
            />
        </>
    );
};
